      ...
      <div class="box">
        <div class="box-header">
          <h3 class="page-header">Biaya Perawatan 
            <a style="float:right;" type="button" class="btn btn-primary btn-sm" href="<?php echo base_url()."Admin/c_pegawai/tambah_pegawai"?>"><i class="fa fa-fw fa-print"></i> Cetak</a>
          </h3>
        </div>
        ...
        <div class="box-body">
            ...
            <form class="form-horizontal" action="<?php echo base_url('index.php/Admin/c_registrasi/update_datapasien') ?>">
              ...
              <div class="timeline-footer">
                ...
                <div class="col-sm-12"> 
                  <a type="button" class="btn btn-info" href="<?php echo base_url()."Admin/c_registrasi/datapasien" ?>"><i class="fa fa-fw fa-money"></i> Bayar</a>
                  <a type="button" class="btn btn-info" href="<?php echo base_url()."Admin/c_pembayaran/data_pembayaran" ?>"><i class="fa fa-fw fa-reply"></i> Kembali</a>
                </div>
                </div>
              </div>
            </form>
