...
class C_masterdata extends CI_Controller {
	...
	public function data_jenjang()
	{
		...
		$this->load->view('backend/v_datajenjang',$data);
	...
	{
		$this->load->view('backend/header');
		$this->load->view('backend/v_tambahjenjang');
		$this->load->view('backend/footer');
	}
	...
	public function input_jenjang()
	{
		...
		if($ber==1){
			redirect('backend/c_masterdata/tambah_jenjang');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_jenjang($id_jenjang)
	{
		...
		$this->load->view('backend/header');
		$this->load->view('backend/v_editjenjang',$data);
		$this->load->view('backend/footer');
	}
	...
	public function update_jenjang()
	{
		...
		redirect('backend/c_masterdata/data_jenjang');
	}
	...
	public function data_jabatan()
	{
		...
		$this->load->view('backend/v_datajabatan',$data);
		$this->load->view('backend/footer');
	}
	...
	{
		$this->load->view('backend/header');
		$this->load->view('backend/v_tambahjabatan');
		$this->load->view('backend/footer');
	}
	...
	public function input_jabatan()
	{
		...
		if($ber==1){
			redirect('backend/c_masterdata/tambah_jabatan');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_jabatan($id_jabatan)
	{
		...
		$this->load->view('backend/header');
		$this->load->view('backend/v_editjabatan',$data);
		$this->load->view('backend/footer');
	}
	...
	public function update_jabatan()
	{
		...
		redirect('backend/c_masterdata/data_jabatan');
	}
	...
	public function data_poli()
	{
		...
		$this->load->view('backend/v_datapoli',$data);
		$this->load->view('backend/footer');
	}
	...
	{
		$this->load->view('backend/header');
		$this->load->view('backend/v_tambahpoli');
		$this->load->view('backend/footer');
	}
	...
	public function input_poli()
	{
		...
		if($ber==1){
			redirect('backend/c_masterdata/tambah_poli');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_poli($id_poli)
	{
		...
		$this->load->view('backend/header');
		$this->load->view('backend/v_editpoli',$data);
		$this->load->view('backend/footer');
	}
	...
	public function update_poli()
	{
		...
		redirect('backend/c_masterdata/data_poli');
	}
	...
	public function data_spesialis()
	{
		...
		$this->load->view('backend/v_dataspesialis',$data);
		$this->load->view('backend/footer');
	}
	...
	{
		$this->load->view('backend/header');
		$this->load->view('backend/v_tambahspesialis');
		$this->load->view('backend/footer');
	}
	...
	public function input_spesialis()
	{
		...
		if($ber==1){
			redirect('backend/c_masterdata/tambah_spesialis');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_spesialis($id_spesialis)
	{
		...
		$this->load->view('backend/header');
		$this->load->view('backend/v_editspesialis',$data);
		$this->load->view('backend/footer');
	}
	...
	public function update_spesialis()
	{
		...
		redirect('backend/c_masterdata/data_spesialis');
	}
	...
	public function data_departement()
	{
		...
		$this->load->view('backend/v_datadepartement',$data);
		$this->load->view('backend/footer');
	}
	...
	{
		$this->load->view('backend/header');
		$this->load->view('backend/v_tambahdepartement');
		$this->load->view('backend/footer');
	}
	...
	public function input_departement()
	{
		...
		if($ber==1){
			redirect('backend/c_masterdata/tambah_departement');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_departement($id_departement)
	{
		...
		$this->load->view('backend/header');
		$this->load->view('backend/v_editdepartement',$data);
		$this->load->view('backend/footer');
	}
	...
	public function update_departement()
	{
		...
		redirect('backend/c_masterdata/data_departement');
	}
	...
	public function data_gedung()
	{
		...
		$this->load->view('backend/v_datagedung',$data);
		$this->load->view('backend/footer');
	}
	...
	{
		$this->load->view('backend/header');
		$this->load->view('backend/v_tambahgedung');
		$this->load->view('backend/footer');
	}
	...
	public function input_gedung()
	{
		...
		if($ber==1){
			redirect('backend/c_masterdata/tambah_gedung');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_gedung($id_gedung)
	{
		...
		$this->load->view('backend/header');
		$this->load->view('backend/v_editgedung',$data);
		$this->load->view('backend/footer');
	}
	...
	public function update_gedung()
	{
		...
		redirect('backend/c_masterdata/data_gedung');
	}
	...
	public function data_rawat()
	{
		...
		$this->load->view('backend/v_datarawat',$data);
		$this->load->view('backend/footer');
	}
	...
	{
		$this->load->view('backend/header');
		$this->load->view('backend/v_tambahrawat');
		$this->load->view('backend/footer');
	}
	...
	public function input_rawat()
	{
		...
		if($ber==1){
			redirect('backend/c_masterdata/tambah_rawat');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_rawat($id_rawat)
	{
		...
		$this->load->view('backend/header');
		$this->load->view('backend/v_editrawat',$data);
		$this->load->view('backend/footer');
	}
	...
	public function update_rawat()
	{
		...
		redirect('backend/c_masterdata/data_rawat');
	}
