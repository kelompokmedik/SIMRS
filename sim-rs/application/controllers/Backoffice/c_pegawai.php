...
class C_pegawai extends CI_Controller {
	...
	public function data_pegawai()
	{
		...
		$this->load->view('Backoffice/v_pegawai',$data);
	...
	public function tambah_pegawai()
	{
		...
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_tambahpegawai',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function aksi_inputpegawai()
	{
		...
		if($ber==1){
			redirect('Backoffice/c_pegawai/tambah_pegawai');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_pegawai($id_pegawai)
	{
		...
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_editpegawai',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function update_pegawai()
	{
		...
		redirect('Backoffice/c_pegawai/data_pegawai');
	}
