...
class C_pembayaran extends CI_Controller {
	...
	{
		$data['tb_regpasien']=$this->m_pembayaran->tampil_data('tb_regpasien');
		$this->load->view('frontoffice/header');
		$this->load->view('frontoffice/v_datapembayaran',$data);
	...
	public function view_detail($id_reg)
	{
		...
		$data['tb_regpasien'] = $this->m_pembayaran->edit_data($where,'tb_regpasien')->result();
		$this->load->view('frontoffice/header');
		$this->load->view('frontoffice/v_prosesbayar',$data);
		$this->load->view('frontoffice/footer');
	}
	...
	/*public function inputdatapasien()
	{
		...
		$this->load->view('frontoffice/header');
		$this->load->view('frontoffice/v_inputdatapasien');
		$this->load->view('frontoffice/footer');
	}
	...
	public function aksi_inputdata()
	{
		...
		if($ber==1){
			redirect('frontoffice/c_registrasi/inputdatapasien');
		}
		else{
			echo "gagal";
		}
	...
	public function editdatapasien($id_reg)
	{
		...
		$this->load->view('frontoffice/header');
		$this->load->view('frontoffice/v_editdatapasien',$data);
		$this->load->view('frontoffice/footer');
	}
	...
	public function update_datapasien()
	{
		...
		redirect('frontoffice/c_registrasi/datapasien');
	}
