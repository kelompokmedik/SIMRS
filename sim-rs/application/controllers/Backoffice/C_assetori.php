...
class C_assetori extends CI_Controller {
	...
	public function data_kategori()
	{
		...
		$this->load->view('Backoffice/v_datakategori',$data);
	...
	public function tambah_kategori()
	{
		...
		$data['tb_kategori']=$this->m_assetori->tampil_data('tb_kategori');
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_tambahkategori',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function aksi_inputkategori()
	{
		...
		if($ber==1){
			redirect('Backoffice/C_assetori/tambah_kategori');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_kategori($id_kategori)
	{
		...
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_editkategori',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function update_kategori()
	{
		...
		redirect('Backoffice/C_assetori/data_kategori');
	}
	...
	public function data_merk()
	{
		...
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_datamerk',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function tambah_merk()
	{
		...
		$data['tb_merk']=$this->m_assetori->tampil_data('tb_merk');
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_tambahmerk',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function aksi_inputmerk()
	{
		...
		if($ber==1){
			redirect('Backoffice/C_assetori/tambah_merk');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_merk($id_merk)
	{
		...
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_editmerk',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function update_merk()
	{
		...
		redirect('Backoffice/C_assetori/data_merk');
	}
	...
	public function data_asset()
	{
		...
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_asset',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function tambah_asset()
	{
		...
		$data['tb_asset']=$this->m_assetori->tampil_data('tb_asset');
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_tambahasset',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function aksi_inputasset()
	{
		...
		if($ber==1){
			redirect('Backoffice/C_assetori/tambah_asset');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_asset($id_asset)
	{
		...
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_editasset',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function update_asset()
	{
		...
		redirect('Backoffice/C_assetori/data_asset');
	}
	...
	public function data_inventori()
	{
		...
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_datainventori',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function tambah_inventori()
	{
		...
		$data['tb_inventori']=$this->m_assetori->tampil_data('tb_inventori');
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_tambahinventori',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function aksi_inputinventori()
	{
		...
		if($ber==1){
			redirect('Backoffice/C_assetori/tambah_inventori');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_inventori($id_inventori)
	{
		...
		$this->load->view('Backoffice/header');
		$this->load->view('Backoffice/v_editinventori',$data);
		$this->load->view('Backoffice/footer');
	}
	...
	public function update_inventori()
	{
		...
		redirect('Backoffice/C_assetori/data_inventori');
	}
