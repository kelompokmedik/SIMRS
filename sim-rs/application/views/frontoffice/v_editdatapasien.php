 <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url('frontoffice/c_registrasi/update_datapasien') ?>" method="post">
              <div class="box-body">
              ...
              <div class="timeline-footer">
                <div class="" align="right">
                  <div class="col-sm-12"> 
                    <a type="button" class="btn btn-default" href="<?php echo base_url()."frontoffice/c_registrasi/datapasien/"?>">Kembali</a>
