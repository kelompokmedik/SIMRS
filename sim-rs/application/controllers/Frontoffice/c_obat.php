...
class C_obat extends CI_Controller {
	...
	public function data_obat()
	{
		...
		$this->load->view('frontoffice/v_dataobat',$data);
	...
	public function tambah_obat()
	{
		...
		$data['tb_obat']=$this->m_obat->tampil_data('tb_obat');
		$this->load->view('frontoffice/header');
		$this->load->view('frontoffice/v_tambahobat',$data);
		$this->load->view('frontoffice/footer');
	}
	...
	public function aksi_inputobat()
	{
		...
		if($ber==1){
			redirect('frontoffice/c_obat/tambah_obat');
		}
		else{
			echo "gagal";
		}
	...
	public function edit_obat($id_obat)
	{
		...
		$this->load->view('frontoffice/header');
		$this->load->view('frontoffice/v_editobat',$data);
		$this->load->view('frontoffice/footer');
	}
	...
	public function update_obat()
	{
		...
		redirect('frontoffice/c_obat/data_obat');
	}
