  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <li><a href="<?php echo base_url()."Dokter/c_beranda"?>"><i class="glyphicon glyphicon-home"></i> Dashboard</a></li>
        </li>
        <li class="treeview">
          <li><a href="<?php echo base_url()."Dokter/c_rekmedis/data_rekmedis"?>"><i class="fa fa-user"></i> <span>Rekam Medis</span></a></li>
        </li>
      </ul>
    </section>
    <!-- /.sidebar -->
