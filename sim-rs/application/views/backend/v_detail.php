 <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url('index.php/backend/c_registrasi/update_datapasien') ?>">
              <div class="box-body">
              ...
              <div class="timeline-footer">
                ...
                <div class="col-sm-12"> 
                  ...
                  <a type="button" class="btn btn-info" href="<?php echo base_url()."backend/c_registrasi/datapasien" ?>"><i class="fa fa-fw fa-mail-reply-all"></i> Keluar</a>
