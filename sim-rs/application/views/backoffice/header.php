  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <li><a href="<?php echo base_url()."Backoffice/c_beranda"?>"><i class="glyphicon glyphicon-home"></i> Dashboard</a></li>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."Backoffice/c_pegawai/data_pegawai"?>"><i class="fa fa-empire"></i> Pegawai</a></li>
            <li><a href="<?php echo base_url()."Backoffice/c_pensiun/data_pensiun"?>"><i class="fa fa-empire"></i> Pensiun</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."Backoffice/c_assetori/data_kategori"?>"><i class="fa fa-empire"></i> Kategori</a></li>
            <li><a href="<?php echo base_url()."Backoffice/c_assetori/data_merk"?>"><i class="fa fa-empire"></i> Merk</a></li>
            <li><a href="<?php echo base_url()."Backoffice/c_assetori/data_asset"?>"><i class="fa fa-empire"></i> Penanggung Jawab</a></li>
            <li><a href="<?php echo base_url()."Backoffice/c_assetori/data_inventori"?>"><i class="fa fa-empire"></i> Inventori</a></li>
          </ul>
        </li>
      </ul>
    </section>
